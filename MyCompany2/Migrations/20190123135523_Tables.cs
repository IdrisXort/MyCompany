    ...
    public partial class Tables : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProjectsAndSkill", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProjectsAndSkill_Projects_ProjectId",
                        column: x => x.ProjectId,
                        principalTable: "Projects",
                        principalColumn: "ProjectId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProjectsAndSkill_Skills_SkillId",
                        column: x => x.SkillId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SkillAndUser", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SkillAndUser_Skills_SkillId",
                        column: x => x.SkillId,
                        principalTable: "Skills",
                        principalColumn: "SkillId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SkillAndUser_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "UserId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserAndProject", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProjectsAndSkill_ProjectId",
                table: "ProjectsAndSkill",
                column: "ProjectId");

            migrationBuilder.CreateIndex(
                name: "IX_ProjectsAndSkill_SkillId",
                table: "ProjectsAndSkill",
                column: "SkillId");

            migrationBuilder.CreateIndex(
                name: "IX_SkillAndUser_SkillId",
                table: "SkillAndUser",
                column: "SkillId");

            migrationBuilder.CreateIndex(
                name: "IX_SkillAndUser_UserId",
                table: "SkillAndUser",
                column: "UserId");
